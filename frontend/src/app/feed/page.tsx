...
export default function Home() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr_auto] gap-3 md:gap-4 px-2 sm:px-3 lg:px-4 xl:px-8 2xl:px-12 py-2 sm:py-3 lg:py-4 mx-auto w-full max-w-screen-xl 2xl:max-w-screen-2xl">
          ...
          {friendsDrawerOpen && (
            <>
              ...
              />
              <div className="fixed right-0 top-0 bottom-0 w-[22rem] max-w-[90vw] bg-[#141414] border-l border-white/10 z-50 xl:hidden">
 ...
 <div className="border border-white/5 max-h-max text-white rounded-xl bg-[#141414] shadow-lg shadow-black/20">
             <div className="w-full flex rounded-xl h-[95vh]">
               ...
               <div className="hidden lg:flex lg:w-0 lg:p-0 lg:border-0 xl:w-64 2xl:w-72 overflow-hidden opacity-0 xl:opacity-100 rounded-r-xl xl:p-4 xl:border-l xl:border-white/10 flex flex-col h-[95vh] xl:bg-[#141414] shrink-0 transition-[width,opacity] duration-300 ease-out">
                   {/* Header */}
